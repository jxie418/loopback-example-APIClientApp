...
Thank you for your interest in `loopback-example-APIClientApp`, an open source project
administered by StrongLoop.

Contributing to `loopback-example-APIClientApp` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-example-APIClientApp)
